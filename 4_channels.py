...
####
		with file('/smc/jianyao/datasets/image_matrix/r_0_0.1_noise_ali/train/QU_7_fre_%s.txt'%(k), 'w') as outfile:
...
os.system('nohup python ../train.py --dataroot /smc/jianyao/datasets/image_matrix/r_0_0.1_noise_ali --name /smc/jianyao/checkpoints/r_0_0.1_noise_ali --model pix2pix --which_model_netG unet_256 --which_direction BtoA --dataset_mode aligned --no_lsgan --norm batch --pool_size 0 --loadSize 256 --fineSize 256 --gpu_ids 0 --input_nc 6 --output_nc 2 --display_freq 1 --batchSize 32 --save_epoch_freq 100 --display_id 0 --niter 300 --niter_decay 300 &')
