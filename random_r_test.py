...
#		cl = cl_real*factor
		rs = random.uniform(0,0.1)	
    		cl_real = produce_cl(rs)	
...
####
		with file('/smc/jianyao/datasets/image_matrix/r_0_0.1_noise_ali/test/QU_7_fre_%s.txt'%(k), 'w') as outfile:
...
####
	...
	#                np.savetxt('/home/jianyao/pytorch-CycleGAN-and-pix2pix/datasets/image_matrix/train/totals%s.txt'%(i+687),combine, fmt = '%.2f')
        ...
        #                np.savetxt('/home/jianyao/pytorch-CycleGAN-and-pix2pix/datasets/image_matrix/train/totals%s.txt'%(i+687),combine, fmt = '%.2f')
                        ...
                        outfile.write('#New dimension\n')
		Fg.append(fg)
np.savetxt('/smc/jianyao/checkpoints/r_0_0.1_noise_ali/norm_factors.txt', Fg)
'''				
