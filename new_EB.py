...
####
		with file('/smc/jianyao/datasets/image_matrix/new_EB_more_data/train/QU_7_fre_%s.txt'%(k), 'w') as outfile:
		    for j in range(1,3):
...
os.system('nohup python ../train.py --dataroot /smc/jianyao/datasets/image_matrix/new_EB_more_data --name /smc/jianyao/checkpoints/new_EB_more_data --model pix2pix --which_model_netG resnet_9blocks --which_direction BtoA --dataset_mode aligned --no_lsgan --norm batch --pool_size 0 --loadSize 44 --fineSize 44 --gpu_ids 1 --input_nc 6 --output_nc 2 --display_freq 1 --batchSize 32 --save_epoch_freq 100 --display_id 0 --niter 300 --niter_decay 300 &')
