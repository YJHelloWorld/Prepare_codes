...
'''
os.system('python ../test.py --dataroot %s --name %s --model pix2pix --which_model_netG unet_32 --which_direction BtoA --dataset_mode aligned --norm batch --input_nc 6 --output_nc 2'%(image_dir, check_dir))
