...
#rs = np.logspace(-5,-0.5,10) ##0402 to help improve the performance at the edges
#####
lmax = 3*nside-1
...
Fg = []; loc = '0410_differ_tensor'; image_dir = '/smc/jianyao/datasets/image_matrix/%s'%loc; check_dir = '/smc/jianyao/checkpoints/%s'%loc;
